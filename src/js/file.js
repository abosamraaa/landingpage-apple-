...
function red(){
    ...
    mainImage.innerHTML = `<img src="/landingpage-apple-/images/4.png">`;
}
function gold(){
    document.body.style.background = "black";
    mainImage.innerHTML = `<img src="/landingpage-apple-/images/0.png">`;
}
function blue(){
    document.body.style.background = "#247ec8";
    mainImage.innerHTML = `<img src="/landingpage-apple-/images/1.png">`;
}
function black(){
    document.body.style.background = "#1e1e1e";
    mainImage.innerHTML = `<img src="/landingpage-apple-/images/2.png">`;
}
function rose(){
    document.body.style.background = "#c79b53";
    mainImage.innerHTML = `<img src="/landingpage-apple-/images/3.png">`;
}
